          ...
          <div class="register-form">
            <form method="POST" action="{{ route('register') }}" name="register-form" class="needs-validation" novalidate="">
              ...
              <div class="form-floating mb-3">
                {{-- value="{{ old('name') }}" : untuk mengambil data yang sudah ada di database --}}
                <input class="form-control form-control_gray @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required="" autocomplete="name" id="name" autofocus="">
                <label for="name">Name</label>
                {{-- @error('name') is-invalid @enderror : untuk menampilkan error di name --}}
                @error('name')
              ...
              <div class="form-floating mb-3">
                ...
                {{-- ini untuk menampilkan error di email, tapi harus diisi dulu di email --}}
                @error('email')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
              ...
              <div class="form-floating mb-3">
                ...
                @error('mobile')
                                    {{-- ini untuk menampilkan error di mobile, tapi harus diisi dulu di mobile --}}
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
              ...
              <div class="form-floating mb-3">
                ...
                @error('password')
                                    {{-- ini untuk menampilkan error di password, tapi harus diisi dulu di password --}}
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
